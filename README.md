...
Reweight a centroid- or bead-mean-biased PIMD trajectory into bead-defined
quantum free energies using an explicit analysis contract:
...
| PIMD free energies | centroid and bead-mean bias, Eq. 8/Eq. 10, OPES weights, restart alignment | [PIMD quantum-FES reweighting](docs/pimd_reweight.md) |
